    ...
    <>
      ...
      <section className="  text-white font-bold bg-second-sm sm:h-48     flex ">
        <div className=" container m-auto flex flex-col   pt-6 pb-6 items-center gap-2 sm:grid  sm:grid-cols-4   ">
          <h3 className="text-2xl lg:text-4xl text-primary-sm0 ">¿ POR QUE ELEGIRNOS?</h3>
      ...
      {
        data.map((project)=>(
          <Project id={project.id} key={project.id} img={project.img} imgTitle={project.descriptionImg} logo={project.logo!} precio={project.details.precio}/>
        ))
      }
          {/* <div>
