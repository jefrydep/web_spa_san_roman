...
const ProjectCard = ({ precio, ubicacion, area }: Props) => {
  ...
  return (
    < >
      <div className="border-2 flex content-center items-center   shadow-sm  justify-between border-primary-sm mx-2 mt-3 p-2 sm:px-7 ">
        <div className="text-5xl font-bold  text-primary-sm"><MdAddLocationAlt/></div>
        
        <div>
          <h4 className="text-center font-bold text-xl">Ubicacion:</h4>
          <h5 className="text-4xl font-bold text-primary-sm">{ubicacion}</h5>
        </div>
      </div>
      <div className="border-2 flex content-center items-center  justify-between border-primary-sm mx-2 mt-3 p-2 sm:px-7 ">
        <div className="text-5xl font-bold text-primary-sm"><MdLandslide/></div>
        
        <div>
          <h4 className="text-center font-bold text-xl">Area :</h4>
      ...
      <div className="border-2 flex content-center items-center  justify-between border-primary-sm mx-2 mt-3 p-2 sm:px-7 ">
        ...
        <div>
          <h4 className="text-center font-bold text-xl"> Precio Desde: </h4>
